...
BWAPI::TilePosition BuildingManager::getBuildingLocation(const Building & b)
{
	...
	if (b.type.isResourceDepot())
	{
		...
		{
			return MapTools::Instance().getNextExpansion(b.macroLocation == MacroLocation::Hidden, b.macroLocation == MacroLocation::MinOnly, b.macroLocation == MacroLocation::EnemyNatural);
		}
	...
	if (b.type == BWAPI::UnitTypes::Zerg_Creep_Colony)
	{
		return BuildingPlacer::Instance().getCreepLocation(b, distance, noVerticalSpacing);
	}
